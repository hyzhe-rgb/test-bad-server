...
export default function MessageInput({ onSendMessage, disabled }: MessageInputProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 p-2 sm:p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 sm:relative sm:border-t-0">
